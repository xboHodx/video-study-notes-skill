...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Prepare a deterministic local audio file for transcription.")
    parser.add_argument("--input", required=True, help="Path to a local audio or video file.")
    parser.add_argument("--output-dir", required=True, help="Directory where the prepared audio file should be stored.")
    parser.add_argument(
        "--audio-name",
        default=None,
